...
class aula4{
    ...
    string num="10";//variaveis globais podem ser acessada de qualque metodo dentro da classe em que ela foi criada 
                //variaveis locais nao podem ter o mesmo nome de uma global
    static void Main(int num2){
        num2 =0;//variaveis locais podem ter o mesmo nome desde que cada uma esteja dentro de seu local especifico
